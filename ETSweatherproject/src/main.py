...
def main():
    ...
    cpro, provincia = weather_api.obtener_provincia()
    cmun, municipio = weather_api.obtener_municipio(cpro)
    ...
    try:
        temp_max, temp_min = weather_api.obtener_datos_actuales_de_municipio(codigo_municipio)
